...
const SnakeGame = () => {
    ...
    return (
        <>
            ...
            <div className="game-container game-container-bg absolute w-[500px] h-[500px] p-5 border border-border-main grid grid-cols-2" onKeyDown={e => changeDirection(e)}>
                ...
                <div className='flex flex-col justify-between z-20'>
                    ...
                    <button onClick={play} className={`p-3 bg-yellow rounded-lg font-semibold`}>
                        Play
                    </button>
                </div>
            </div>
