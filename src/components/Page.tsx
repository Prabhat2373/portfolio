        ...
        <div className=" border-border-main">
          <div className="grid">
            <details className="text-white">
              <summary className="border-b-2  border-t border-border-main px-4 py-3">
                {sidebarName}
              </summary>
              <div className="pt-4">{sidebarDetails}</div>
            </details>
          </div>
          <div>
      ...
      <div className=" col-span-10">
        <div className="top-bar border border-border-main ">
          <div className="top grid col-span-full h-[50px] border border-l-0 border-border-main border-t-0">
            <span className="text-text-main border-r border-border-main flex items-center gap-6 absolute p-3">
              {dataTabName}
              <CloseIcon className="cursor-pointer hover:fill-white" />
            </span>
          </div>
        </div>
        <div className="content overflow-y-scroll h-[76.4vh]">{content}</div>
      </div>
    </section>
  );
};
